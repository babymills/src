...
public class Test_001011000111010111110_8 {

    public static void main(String[] args) throws IOException {
        // PREPARE
        final int BUFF_LEN = 8;
        ...
        List<String> expectedHistory = asList(
                "read(b[8])", "write(b[8],2,1)", "write(b[8],4,2)",
                "read(b[8])", "write(b[8],1,3)", "write(b[8],5,1)", "write(b[8],7,1)",
                "read(b[8])", "write(b[8],0,4)",
                "read(b[8])"
        );
