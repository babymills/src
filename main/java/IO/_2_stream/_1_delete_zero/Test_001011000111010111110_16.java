...
public class Test_001011000111010111110_16 {

    public static void main(String[] args) throws IOException {
        // PREPARE
        final int BUFF_LEN = 16;
        ...
        List<String> expectedHistory = asList(
                "read(b[16])", "write(b[16],2,1)", "write(b[16],4,2)", "write(b[16],9,3)", "write(b[16],13,1)", "write(b[16],15,1)",
                "read(b[16])", "write(b[16],0,4)",
                "read(b[16])"
        );
