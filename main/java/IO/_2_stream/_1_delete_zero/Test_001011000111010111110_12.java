...
public class Test_001011000111010111110_12 {

    public static void main(String[] args) throws IOException {
        // PREPARE
        final int BUFF_LEN = 12;
        ...
        List<String> expectedHistory = asList(
                "read(b[12])", "write(b[12],2,1)", "write(b[12],4,2)", "write(b[12],9,3)",
                "read(b[12])", "write(b[12],1,1)", "write(b[12],3,5)",
                "read(b[12])"
        );
