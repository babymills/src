...
public class Test_OOO_O_FFF {
    public static void main(String[] args) throws Throwable {
        ...
        try {
            ...
            if (!"resourceС".equals(e.getMessage())) {
                throw new AssertionError();
            }
            if (e.getSuppressed().length != 2) {
                throw new AssertionError();
            }
            if (!"resourceB".equals(e.getSuppressed()[0].getMessage())) {
                throw new AssertionError();
            }
            if (!"resourceA".equals(e.getSuppressed()[1].getMessage())) {
                throw new AssertionError();
            }
        }
